...
type LiveResultActiveEvent struct {
	...
	OpenedEventStory      generic.Nullable[EventResultOpenedNewStory]        `json:"opened_event_story"`        // pointer
	LiveEventDropItemInfo generic.Nullable[LiveEventDropItemInfo]            `json:"live_event_drop_item_info"` // pointer
	PointReward           generic.Nullable[LiveResultActiveEventPointReward] `json:"point_reward"`              // pointer
