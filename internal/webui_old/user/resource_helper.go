...
func init() {
	...
	server.AddHandler("/webui/user", "GET", "/resource_helper", resourceHelperForm)
	server.AddHandler("/webui/user", "POST", "/resource_helper", resourceHelperHandler)
	server.AddHandler("/webui/user", "POST", "/accessory", AccessoryHandler)
